...
(function() {
	...
	var factory = function (exports) {
		...
		var $            = jQuery;
		var pluginName   = "dataManagement-dialog";
		...
		exports.fn.tableDialog = function() {
				...
				dialog = this.createDialog({
					...
					buttons    : {
                        enter : [lang.buttons.enter, function() {
							...
							var align  = this.find("[name=\"dataManagement-align\"]:checked").val();
							var table  = "";
							var hrLine = "------------";
			...
			if (faBtns.html() === "")
			{
				...
				for (var i = 0, len = icons.length; i < len; i++) 
				{
					...
					var btn = "<a href=\"javascript:;\"><label for=\"editormd-dataManagement-dialog-radio"+i+"\" title=\"" + _lang[i] + "\">";
					btn += "<input type=\"radio\" name=\"dataManagement-align\" id=\"editormd-dataManagement-dialog-radio"+i+"\" value=\"" + values[i] + "\"" +checked + " />&nbsp;";
